        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div>
              ...
              <span className={`block text-[8px] font-bold tracking-widest uppercase -mt-1.5 transition-colors duration-300 ${isHomeAndNotScrolled ? "text-white/60" : "text-muted-foreground"}`}>
