...
export default function TrekDetailPageClient({ trek }: { trek: typeof TREKS[0] | null }) {
      ...
      <>
        ...
        <main className="flex-grow pt-32 pb-20 flex items-center justify-center">
          <div className="text-center space-y-4 p-8 rounded-2xl border border-border bg-card max-w-md mx-auto">
            ...
            <h1 className="text-2xl font-black">Expedition Not Found</h1>
            <p className="text-xs text-muted-foreground">The trekking package you are looking for does not exist or has been archived.</p>
            <Link href="/treks">
              <Button size="sm" className="mt-4">Back to Expedition Packages</Button>
            </Link>
          </div>
        </main>
        <Footer />
          ...
          <div className="absolute bottom-8 left-0 right-0 z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="flex items-center gap-1 text-xs text-slate-300 font-bold bg-slate-900/60 backdrop-blur-md px-2.5 py-0.5 rounded-full border border-white/10">
                  <Calendar className="h-3 w-3 text-primary" /> Best Season: {trek.season}
                </span>
              </div>
              ...
              <div className="flex border-b border-border gap-6 overflow-x-auto no-scrollbar pt-1 sticky top-16 bg-background z-20">
                {(["overview", "itinerary", "inclusions", "faqs"] as const).map((tab) => (
                  <button
                    ...
                    className="text-sm font-bold uppercase tracking-wider pb-3 border-b-2 transition-all cursor-pointer border-transparent text-muted-foreground hover:text-foreground"
              ...
              <div className="border border-border rounded-2xl bg-card p-6 shadow-sm sticky top-24 space-y-6">
                ...
                <div className="space-y-3.5 text-xs">
                  ...
                  {trek.altitude && (
                    <div className="flex justify-between font-semibold">
                      <span className="text-muted-foreground flex items-center gap-1.5">
                        <Compass className="h-4 w-4 text-primary" /> Max Altitude
                      </span>
                  ...
                  <div className="flex justify-between font-semibold">
                    ...
                    <span className="font-bold">{trek.season}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3.5 rounded-xl bg-secondary/50 border border-border text-[10px] leading-relaxed text-muted-foreground">
                  ...
                  <span>
                    <strong>Himalayan Warrior Guarantee:</strong> certified IMF/NIM mountaineer leaders, oxygen support cylinders, altitude first-aid medicine boxes, and strict zero-waste ecological trekking.
                  </span>
                </div>
              </div>
            </div>
