...
export default function ContactPage() {
  ...
  const saveContactLocally = (contact: any) => {
    try {
      const existing = localStorage.getItem("himalayanwarrior_contacts") || "[]";
      ...
      localStorage.setItem("himalayanwarrior_contacts", JSON.stringify(contactsList));
    } catch (e) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="p-6 rounded-2xl border border-border bg-card space-y-4">
                ...
                <ul className="space-y-4 text-xs sm:text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <a href="tel:+917249936622" className="hover:text-primary transition-colors block font-semibold text-foreground">
                        +91-7249936622
                      </a>
                      <a href="tel:+917819962465" className="hover:text-primary transition-colors block font-semibold text-foreground text-xs">
                        +91-7819962465 (Helpline 2)
                      </a>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="hover:text-primary transition-colors block font-semibold text-foreground"
                      >
                        +91-9456582262 (WhatsApp)
                      </a>
                      <span className="text-[10px] text-muted-foreground block">Instant Chat Support Support</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <div>
                      <a href="mailto:himalayanwarrior1@gmail.com" className="hover:text-primary transition-colors block font-semibold text-foreground text-xs sm:text-sm">
                        himalayanwarrior1@gmail.com
                      </a>
                      <span className="text-[10px] text-muted-foreground block">General & Group Booking Inquiries</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <MapPin className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                    <div>
                      <span className="block font-semibold text-foreground">Registered Office</span>
              ...
              <div className="p-6 rounded-2xl border border-primary/20 bg-primary/5 text-xs text-muted-foreground leading-relaxed space-y-2">
                <span className="font-extrabold text-primary block uppercase tracking-wider">Himalayan Route Safety</span>
                <p>
                  Safety is our utmost priority. During winter snowstorms or heavy monsoon rains, trails can be closed by the Uttarakhand Forest Department. We monitor weather stations continuously to ensure safe treks.
                </p>
              </div>
            </div>
              ...
              {success ? (
                <div className="text-center py-8 space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground max-w-sm mx-auto leading-relaxed">
                    Thank you for reaching out. A coordinator from Himalayan Warrior will get in touch with you via email or phone within the next 4 hours.
                  </p>
